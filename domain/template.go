...
type ScreenItem struct {
	Resourcetype int      `xml:"resourcetype,omitempty" json:"resourcetype,omitempty" yaml:"resourcetype,omitempty"`
	Style        int      `xml:"style,omitempty" json:"style,omitempty" yaml:"style,omitempty"`
	...
	Valign       int      `xml:"valign,omitempty" json:"valign,omitempty" yaml:"valign,omitempty"`
	Halign       int      `xml:"halign,omitempty" json:"halign,omitempty" yaml:"halign,omitempty"`
	Dynamic      int      `xml:"dynamic,omitempty" json:"dynamic,omitempty" yaml:"dynamic,omitempty"`
	SortTriggers int      `xml:"sort_triggers,omitempty" json:"sort_triggers,omitempty" yaml:"sort_triggers,omitempty"`
	URL          string   `xml:"url,omitempty" json:"url,omitempty" yaml:"url,omitempty"`
